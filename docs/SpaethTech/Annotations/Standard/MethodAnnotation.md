...
* Full name: `\SpaethTech\Annotations\Standard\MethodAnnotation`
...
| Constant | Type | Value |
|:---------|:-----|:------|
|`\SpaethTech\Annotations\Standard\MethodAnnotation::SUPPORTED_TARGETS`||\SpaethTech\Annotations\Annotation::TARGET_CLASS|
|`\SpaethTech\Annotations\Standard\MethodAnnotation::SUPPORTED_DUPLICATES`||true|
...
```php
public MethodAnnotation::parse(array $existing = []): array
```
