...
* Full name: `\SpaethTech\Annotations\Standard\ReturnAnnotation`
...
| Constant | Type | Value |
|:---------|:-----|:------|
|`\SpaethTech\Annotations\Standard\ReturnAnnotation::SUPPORTED_TARGETS`||\SpaethTech\Annotations\Annotation::TARGET_METHOD|
|`\SpaethTech\Annotations\Standard\ReturnAnnotation::SUPPORTED_DUPLICATES`||false|
...
```php
public ReturnAnnotation::parse(array $existing = []): array
```
