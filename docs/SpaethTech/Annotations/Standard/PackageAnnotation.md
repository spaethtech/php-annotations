...
* Full name: `\SpaethTech\Annotations\Standard\PackageAnnotation`
...
| Constant | Type | Value |
|:---------|:-----|:------|
|`\SpaethTech\Annotations\Standard\PackageAnnotation::SUPPORTED_TARGETS`||\SpaethTech\Annotations\Annotation::TARGET_CLASS|
|`\SpaethTech\Annotations\Standard\PackageAnnotation::SUPPORTED_DUPLICATES`||false|
...
```php
public PackageAnnotation::parse(array $existing = []): array
```
